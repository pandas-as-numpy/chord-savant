...
chroma_vamp_lib = '/content/drive/MyDrive/chord_savant-20230617T043615Z-001/chord_savant/src/chord_savant/res/nnls-chroma.so'
chroma_vamp_key = 'nnls-chroma:nnls-chroma'
model_source = 'https://drive.google.com/uc?id=1XBn7FyYjF8Ff6EuC7PjwwPzFBLRXGP7n'
res_directory = os.path.join(os.path.expanduser('~'), '.chord_savant-20230617T043615Z-001')
